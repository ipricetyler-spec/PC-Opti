...
3. In an entitled advanced profile, open **Background apps**, refresh the inventory, and select a non-system background process. Confirm the dialog explains Windows EcoQoS, states that it is not an FPS boost, warns against games/launchers, and explains the rollback limit before applying it.
